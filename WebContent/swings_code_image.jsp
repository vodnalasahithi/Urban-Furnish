...
String query="select Product_Id,image,product_name,description,price from productdetails where category='swings'";
...
%>
	...
	<div class="row">
		<div class="column">
			<b><img alt="" src="swingsreadImage.jsp?ProductId=<%=ProductId%>"
