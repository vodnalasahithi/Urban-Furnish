...
%>
	...
	<div class="row">
		<div class="column">
			<b><img alt="" src="readImage.jsp?ProductId=<%=ProductId%>"
				align="center" height="300" width="300"></b>
		</div>
		<div class="well">
		
		
			<c:out name = "product_name" value= rs.getString("product_name)  />
 			<b>Name :</b><%=rs.getString("product_name")%></br>
 			 <b>Description :</b><%=rs.getString("description")%>
			</br> <b>Price :</b><%=rs.getString("price")%></br>
