...
String query="select Product_Id,image,product_name,description,price from productdetails where category='tv stands'";
...
%>
	...
	<div class="row">
		<div class="column">
			<b><img alt="" src="tvstandsreadImage.jsp?ProductId=<%=ProductId%>"
